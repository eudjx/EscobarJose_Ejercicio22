...
class TestComplejo(unittest.TestCase):
    ...
    def test_mult(self):
        ...
        c=(a,b)
        x=mult(c)
        self.assertEqual(c.mult, -1.0)
        
        d=complejo.Complejo(10,15)
        e=complejo.Complejo(3,4)
        f=d.mult(e)
        self.assertAlmostEqual(f.mult, 2.0)
        
        h=complejo.Complejo(2,1)
        i=complejo.Complejo(6,3)
        j=h,mult(i)
        self.assertEqual(j.mult, 5.0)
